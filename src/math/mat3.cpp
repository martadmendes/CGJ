...
math::mat3 math::transpose(mat3& m) {
	return mat3(m.data[0], m.data[3], m.data[6], m.data[1], m.data[4], m.data[7], m.data[2], m.data[5], m.data[8]);
}

math::mat3 math::inverse(mat3& m) {
	return mat3();
}
