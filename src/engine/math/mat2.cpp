...
engine::math::mat2::mat2() : data{ 0.0f } {}

engine::math::mat2::mat2(const float k) : data{ k, 0.0f, 0.0f, k } {}

engine::math::mat2::mat2(const float m0, const float m1, const float m2, const float m3) : data{ m0, m1, m2, m3 } {}
...
float engine::math::mat2::determinant() const {
	return data[0]*data[3] - data[2]*data[1];
}

engine::math::mat2 engine::math::mat2::transpose() const {
	return mat2(data[0], data[2], 
				data[1], data[3]);
}

engine::math::mat2 engine::math::mat2::inverse() const {
...
engine::math::mat2 engine::math::operator+(const mat2& m1, const mat2& m2) {
	mat2 result;
	for (int i = 0; i <= 3; i++) {
...
engine::math::mat2 engine::math::operator*(const mat2& m, const float k) {
	mat2 result;
	for (int i = 0; i <= 3; i++) {
...
engine::math::mat2 engine::math::operator*(const float k, const mat2& m) {
	return m * k;
}

engine::math::vec2 engine::math::operator*(const mat2& m, const engine::math::vec2 v) {
...
bool engine::math::operator==(const mat2& m1, const mat2& m2) {
	for (int i = 0; i <= 3; i++) {
